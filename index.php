...
<head>
    ...
    <link rel="shortcut icon" href="src/images/kairoo.png" type="image/x-icon">
</head>

<body class="py-4">
    <main class="w-100 m-auto text-center mainForm">
        <form action="src/backend/login_user.php" method="post" class="needs-validation" novalidate>
            ...
            <button type="submit" class="btn button w-100 py-3">Entrar</button>
            <button type="button" class="btn button w-100 py-3 mt-3">
                <a href="register.php" class="text-decoration-none text-white">Cadastrar-se</a>
            </button>
        </form>
    </main>

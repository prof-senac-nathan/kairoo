...
<body class="py-4">
    <main class="w-100 m-auto text-center mainForm">
        <form action="../backend/login_user.php" method="post" class="needs-validation" novalidate>
            ...
            <a href="register.php" class="text-decoration-none text-white btn button w-100 py-3 mt-3">Cadastrar-se</a>
        </form>
    </main>

...
<body>
            ...
            <ul class="nav">
                ...
                <li class="nav-item d-sm-none d-md-block d-none d-sm-block">
                    <a href="createRoom.php"
                        class="text-decoration-none rounded-pill fw-bold btn-header d-flex justify-content-center p-1 fs-5">CRIAR SALA</a>
                </li>
    ...
    <h1>Olá, Professor, venha Criar sua SALA!!!</h1>

...
<nav class="navbar bg-header py-4">
    <div class="container-fluid ms-3 me-3">
        ...
        <ul class="nav">
            ...
            <li class="nav-item d-sm-none d-md-block d-none d-sm-block">
            <a href="play.php" class="text-decoration-none active rounded-pill fw-bold btn-header d-flex justify-content-center p-1 fs-5" aria-current="page">JOGAR</a>
            </li>
        ...
        <div class="collapse navbar-collapse d-xxl-none d-xl-none d-xxl-block d-lg-none d-xl-block d-md-none d-lg-block" id="navbarTogglerDemo02">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                ...
                <a class="btn-collapseBar fw-bold py-2 text-decoration-none rounded-3 d-flex justify-content-center" href="home.php">INICIO</a>
                </li>
                ...
                <li class="nav-item">
                <a class="active fw-bold py-2 text-decoration-none rounded-3 d-flex justify-content-center" aria-current="page" href="#">JOGAR</a>
                </li>
            </ul>
        </div>
    </div>
